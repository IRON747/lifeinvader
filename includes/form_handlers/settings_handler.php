	...
	if(md5($old_password) == $db_password) {
		...
		if($new_password_1 == $new_password_2) {
			if($new_password_1 == $old_password){
					$password_message = "Your new passwords cannot be same as the old one!<br><br>";
			}

			else if(strlen($new_password_1) <= 4) {
				$password_message = "Your password must have atleast 4 characters!<br><br>";
			}	
			else {
			...
			$password_message = "Please type the old password first! <br><br>";
	}
	else {
