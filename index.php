	...
	$(document).ready(function() {
		...
		$(window).scroll(function() {
			...
			var noMorePosts = $('.posts_area').find('.noMorePosts').val();
			  ...
			  if ((document.body.scrollHeight == document.body.scrollTop + window.innerHeight) && noMorePosts == 'false') {  //if noMorePost is true this wont execute; there are posts to be loaded
